 ...
 * 
 * Original found here: https://github.com/bradvin/Featured-Image-Metabox-Customizer-Class
 * 
 */
	...
	class Featured_Image_Metabox_Customizer {
		...
		function change_featured_image_metabox_title($post_type) {
			if ( $post_type === $this->post_type ) {
				...
				add_meta_box( 'postimagediv', $this->metabox_title, 'post_thumbnail_meta_box', $this->post_type, 'normal', 'high' );
			}
		}
